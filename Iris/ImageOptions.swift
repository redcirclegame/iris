...
public struct ImageOptions: Equatable {
    ...
    */
    public var queryItems: [URLQueryItem] {
        ...
        if let value = width {
            items.append(URLQueryItem(name: "w", value: String(value)))
        }

        if let value = height {
            items.append(URLQueryItem(name: "h", value: String(value)))
        }
        ...
        if let value = scale {
            items.append(URLQueryItem(name: "dpr", value: String(value)))
        }
